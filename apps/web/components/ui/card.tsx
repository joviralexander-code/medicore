...
>(({ className, variant = 'default', ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      variant === 'elevated'    && 'shadow-elevated border-transparent',
      variant === 'flat'        && 'border-border shadow-none',
      variant === 'interactive' && 'shadow-card hover:shadow-hover hover:-translate-y-0.5 transition-all duration-200 cursor-pointer',
      className
    )}
    {...props}
  />
